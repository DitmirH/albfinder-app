...
import {
  ...
  BadgePoundSterling, CircleDollarSign
} from 'lucide-react'
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between p-6 pb-4 hover:bg-slate-50/50 transition-colors text-left"
      >
...
export default function DirectorDetailPage({ data }) {
  const { id } = useParams()
          ...
          <div className="flex items-center h-16 gap-4">
            ...
            {record.data_enrichment_last && (
              <div className="hidden sm:flex items-center gap-1.5 text-xs text-slate-400">
                ...
                Last updated: {record.data_enrichment_last}
              </div>
            )}
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-6">
          ...
          {/* ═══════════════════════════════════════════════════════════
             ...
             ═══════════════════════════════════════════════════════════ */}
          {record.ai_summary && (
            <div className="bg-gradient-to-r from-indigo-50 via-blue-50 to-purple-50 rounded-xl border border-indigo-100 p-6">
          ...
          {/* ═══════════════════════════════════════════════════════════
             ...
             ═══════════════════════════════════════════════════════════ */}
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            <h3 className="text-sm font-semibold text-slate-900 uppercase tracking-wider mb-5 flex items-center gap-2">
              <Phone className="w-4 h-4 text-indigo-500" /> Contact Details
              {enrichedData && (
                <span className="ml-auto inline-flex items-center gap-1 px-2 py-0.5 bg-emerald-50 text-emerald-600 rounded-full text-xs font-medium normal-case">
